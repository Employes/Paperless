...
describe('p-illustration-deprecated', () => {
	it('renders', async () => {
		const page = await newSpecPage({
			...
			html: `<p-illustration-deprecated icon="document"></p-illustration-deprecated>`,
		});
		expect(page.root).toEqualHtml(`
      <p-illustration-deprecated icon="document" class="p-illustration-deprecated inline-block text-auto hydrated" innerhtml="<?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?>
